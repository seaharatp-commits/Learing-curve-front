...
export const getCareerAlignmentApi = () =>
  mainClient.get<CareerAlignment>("/skill-radar/me/career-alignment");
...
export const createPositionSkillsApi = (positionId: string, payload: PositionSkillPayload[]) =>
  mainClient.post<SkillRadarSkill[]>(`/skill-radar/admin/positions/${positionId}/skills/bulk`, {
    skills: payload,
  });
...
export const deletePositionSkillApi = (id: string) =>
  mainClient.delete<{ success: boolean }>(`/skill-radar/admin/skills/${id}`);
